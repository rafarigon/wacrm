        ...
        <div className="flex flex-col gap-3">
          {buttons.map((b, i) => (
            <div
              key={i}
              className={cn(
                "grid grid-cols-1 gap-2 rounded-md border border-gray-200 bg-gray-50 p-3",
                showAdvanced
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div>
          <label className="mb-1 block text-xs text-gray-500">If</label>
          <Select
            value={subject}
            onValueChange={(v) =>
...
function SendMediaForm({
  ...
  return (
    <>
      <div>
        <label className="mb-1 block text-xs text-gray-500">Media type</label>
        <Select
          value={mediaType}
          onValueChange={(v) => {
      ...
      <div>
        <label className="mb-1 block text-xs text-gray-500">File</label>
        {cfg.media_url ? (
          <div className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 text-xs">
            ...
            <a
              ...
              className="min-w-0 flex-1 truncate text-gray-800 hover:text-cyan-700"
          ...
          <button
            ...
            disabled={uploading}
            className="flex w-full items-center justify-center gap-2 rounded-md border border-dashed border-gray-200 bg-gray-50 px-3 py-4 text-xs text-gray-500 transition-colors hover:border-gray-400 hover:bg-gray-50 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {uploading ? (
              <>
