  ...
  return (
    <div className="space-y-6 mt-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Account members</h2>
                ...
                >
                  <div className="flex min-w-0 flex-1 items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {isSelf && (
                          <Badge className="bg-white text-gray-700 border-gray-200 text-[10px] uppercase tracking-wide">
                            You
                          </Badge>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    {canManageMembers && !isOwnerRow && !isSelf ? (
                      ...
                      >
                        <SelectTrigger
                          className="w-32 bg-white border-gray-200 text-gray-800"
                          disabled={isBusy}
                        >
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    {canManageMembers && !isOwnerRow && !isSelf && (
                      <Button
                        ...
                        disabled={isBusy}
                        className="border-red-500/40 bg-red-500/10 text-red-700 hover:bg-red-500/20 hover:border-red-500/60 hover:text-red-200"
                      >
      ...
      <RequireRole min="admin">
        <div>
          <div className="mb-2 flex items-center gap-2">
            ...
            <Badge className="bg-white text-gray-500 border-gray-200">
              {invitations.length}
            </Badge>
          </div>
            ...
            <Card className="bg-gray-50 border-gray-200 ring-0 ring-transparent">
              <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="mt-1 text-xs text-gray-400">
                  Click <span className="text-gray-700">Invite member</span>{' '}
