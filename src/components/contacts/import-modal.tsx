...
export function ImportModal({ open, onOpenChange, onImported }: ImportModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="bg-gray-50 border-gray-200 text-gray-800 sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-gray-900">Import Contacts</DialogTitle>
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-200 p-6 cursor-pointer hover:border-primary/50 transition-colors"
          >
            {file ? (
              <>
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-white">
                      ...
                      <th className="px-3 py-1.5 text-left text-gray-500 font-medium">Company</th>
                    </tr>
                  </thead>
                  <tbody>
                    {preview.map((row, i) => (
                      <tr key={i} className="border-t border-gray-200">
                        ...
                        <td className="px-3 py-1.5 text-gray-700">{row.company || '-'}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
