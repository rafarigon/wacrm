...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-gray-700">Quick-start templates</h2>
            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-gray-200 bg-gray-50 p-4 text-left transition-colors hover:border-primary/50 hover:bg-gray-100"
                >
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 bg-gray-50">
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-gray-900">{pendingDelete?.name}</span> and its execution
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl border border-gray-200 bg-gray-50 transition-colors hover:border-gray-300">
      <div className="flex items-center gap-4 p-4">
        ...
        >
          ...
          {automation.description && (
            <p className="mt-0.5 truncate text-xs text-gray-500">{automation.description}</p>
          )}
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-900 data-[popup-open]:bg-white"
            >
